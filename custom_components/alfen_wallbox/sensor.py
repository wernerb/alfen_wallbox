...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities([
        ...
        AlfenSensor(device, 'GPRS Url Server Domain And Port', 'comm_bo_url_gprs_server_domain_and_port'),
        AlfenSensor(device, 'GPRS Url Server Path', 'comm_bo_url_gprs_server_path'),
        AlfenSensor(device, 'GPRS Url DNS 1', 'comm_bo_url_gprs_dns_1'),
        AlfenSensor(device, 'GPRS Url DNS 2', 'comm_bo_url_gprs_dns_2'),
