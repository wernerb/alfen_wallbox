...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities([
        ...
        AlfenSensor(device, 'P1 Meter Phase 1 Current', 'p1_measurements_1'),
        AlfenSensor(device, 'P1 Meter Phase 2 Current', 'p1_measurements_2'),
        AlfenSensor(device, 'P1 Meter Phase 3 Current', 'p1_measurements_3'),
        ...
        AlfenSensor(device, 'Wired Url Server Domain And Port', 'comm_bo_url_wired_server_domain_and_port'),
        AlfenSensor(device, 'Wired Url Wired Server Path', 'comm_bo_url_wired_server_path'),
        AlfenSensor(device, 'GPRS DHCP Address', 'comm_dhcp_address_1'),
        AlfenSensor(device, 'GRPS Netmask', 'comm_netmask_address_1'),
        AlfenSensor(device, 'GRPS Gateway Address', 'comm_gateway_address_1'),
        AlfenSensor(device, 'GRPS IP Address', 'comm_ip_address_1'),
        AlfenSensor(device, 'Backoffice Short Name', 'comm_bo_short_name'),
        AlfenSensor(device, 'GRPS Url Server Domain And Port', 'comm_bo_url_gprs_server_domain_and_port'),
        AlfenSensor(device, 'GRPS Url Server Path', 'comm_bo_url_gprs_server_path'),
        AlfenSensor(device, 'GRPS Url DNS 1', 'comm_bo_url_gprs_dns_1'),
        AlfenSensor(device, 'GRPS Url DNS 2', 'comm_bo_url_gprs_dns_2'),
        ...
        AlfenSensor(device, 'Wired Url DNS 1', 'comm_bo_url_wired_dns_1'),
        AlfenSensor(device, 'Wired Url DNS 2', 'comm_bo_url_wired_dns_2'),
